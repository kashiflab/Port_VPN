...
import elink.vpn.app.BuildConfig;
import elink.vpn.app.MainActivity;
...
public class OpenVPNService extends VpnService implements StateListener, Callback, ByteCountListener {
    ...
    private static String humanReadAbleByte;
    ...
    public static String humanReadableByteCount(long bytes, boolean mbit) {
        ...
        if (mbit) {
            ...
            humanReadAbleByte = String.format(Locale.getDefault(), "%.1f %sB", bytes / Math.pow(unit, exp), pre);
            return humanReadAbleByte;
        }
    }

    private void setUPDW(String netstat){
        String[] updw = netstat.split("-");
        MainActivity.downloadtv.setText(updw[0]);
        MainActivity.uploadtv.setText(updw[1]);
    }

    public static String getHumanReadAbleByte(){
        return humanReadAbleByte;
    }
...
//    }
    ...
    private void showNotification(final String msg, String tickerText, boolean lowpriority, long when, ConnectionStatus status) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            startForeground(OPENVPN_STATUS, notification1);
    ...
    public void updateByteCount(long in, long out, long diffIn, long diffOut) {
        if (mDisplayBytecount) {
            netstat = String.format(getString(R.string.statusline_bytecount), humanReadableByteCount(in, false), humanReadableByteCount(diffIn / OpenVPNManagement.mBytecountInterval, false), humanReadableByteCount(out, false), humanReadableByteCount(diffOut / OpenVPNManagement.mBytecountInterval, false));
