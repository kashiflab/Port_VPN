...
public class VpnStatus {
    ...
    public static boolean isVPNActiveLatest() {
    ...
    public static boolean isVPNNotConnect() {
        return mLastLevel == ConnectionStatus.LEVEL_NOTCONNECTED;
    }

    public static boolean isVPNConnecting() {
        return (mLastLevel == ConnectionStatus.LEVEL_START)
                || (mLastLevel == ConnectionStatus.LEVEL_CONNECTING_NO_SERVER_REPLY_YET)
...
*/
    ...
    private static void newLogItem(LogItem logItem) {
        Log.e("Log Of inside>> ", logItem.getLogLevel() + "<-->" + logItem.toString());
