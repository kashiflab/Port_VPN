...
//                password = passwordInput.getText().toString();
                ...
                if(email.length() == 0)
                {
                    show_msg("Please enter your nickname");
                    return;
                }
...
//                }
    ...
    public void do_login()
    {
        ...
        String un_id = ICSOpenVPNApplication.id(NicknameActivity.this);

        CustomRequest jsonReq = new CustomRequest(Request.Method.POST, Constants.API_DOMAIN+"set_nickname", null,
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if (response.getString("action").equals("success")) {
                                ...
                                Intent i = new Intent(NicknameActivity.this, MainActivity.class);
                                startActivity(i);
...
//                                    Toast.makeText(getApplicationContext(), response.toString(), Toast.LENGTH_SHORT).show();
                                ...
                                new SweetAlertDialog(NicknameActivity.this, SweetAlertDialog.NORMAL_TYPE)
    ...
    protected void initpDialog() {
        ...
        pDialog = new SweetAlertDialog(NicknameActivity.this, SweetAlertDialog.PROGRESS_TYPE);
